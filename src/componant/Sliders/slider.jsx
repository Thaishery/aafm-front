...
const Slider = ({slides})=>{
  ...
  const handelPrevious = ()=>{
    if(activeSlide -1 < 0) setActiveSlide(0);
  ...
  return(
    <div className="slider">
      ...
      { slides.map((slide,key)=>{return <Slide  src={slide.src} alt={slide.alt} havecaptions={slide.havecaptions} title={slide.title} desc={slide.desc} active={key==activeSlide?true:false} />})}
    </div>
  )
}
