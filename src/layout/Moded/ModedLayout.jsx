...
const ModedLayout = () =>{ 
  ...
  const defaultMenu = [
    {path:"/",link:"Accueil"},{path:"/moderation", link:"Moderation"},{path:"/categories", link:"Catégories"},{path:"/activitees",link:"Activités"},{path:"/monCompte",link:"Mon Compte"},{path:'/Deconnection', link:'Déconnection'}
  ]
